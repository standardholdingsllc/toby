...
export const initialAppointments: Appointment[] = [
  ...
  // January 2026 Appointments (with variance - 1-4 per day, Mondays not blank)
  ...
  { id: '13', date: '2026-01-03', time: '14:30', petId: '12', petName: 'Thor', ownerId: '8', ownerName: 'Miguel Torres', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },
  { id: '14', date: '2026-01-06', time: '09:00', petId: '14', petName: 'Ginger', ownerId: '9', ownerName: 'Jennifer Lee', type: 'Check-up', status: 'scheduled', notes: 'Senior pet check-up' },
  { id: '15', date: '2026-01-06', time: '11:00', petId: '15', petName: 'Duke', ownerId: '10', ownerName: 'David Kim', type: 'Grooming', status: 'scheduled', notes: 'Full service grooming' },
  { id: '16', date: '2026-01-06', time: '14:30', petId: '16', petName: 'Princess', ownerId: '10', ownerName: 'David Kim', type: 'Vaccination', status: 'scheduled', notes: 'Feline leukemia booster' },
  ...
  { id: '18', date: '2026-01-08', time: '09:00', petId: '18', petName: 'Mochi', ownerId: '11', ownerName: 'Sofia Reyes', type: 'Vaccination', status: 'scheduled', notes: 'Puppy series completion' },
  { id: '19', date: '2026-01-08', time: '14:00', petId: '19', petName: 'Charlie', ownerId: '12', ownerName: 'James Wilson', type: 'Check-up', status: 'scheduled', notes: 'Senior dog wellness' },
  { id: '20', date: '2026-01-09', time: '10:30', petId: '20', petName: 'Pepper', ownerId: '12', ownerName: 'James Wilson', type: 'Vaccination', status: 'scheduled', notes: 'Annual feline vaccination' },
  { id: '21', date: '2026-01-10', time: '09:30', petId: '21', petName: 'Lola', ownerId: '13', ownerName: 'Isabella Martinez', type: 'Check-up', status: 'scheduled', notes: 'Anxiety behavior assessment' },
  { id: '22', date: '2026-01-10', time: '14:00', petId: '22', petName: 'Zeus', ownerId: '14', ownerName: 'William Brown', type: 'Grooming', status: 'scheduled', notes: 'Show dog grooming' },
  { id: '23', date: '2026-01-13', time: '09:00', petId: '23', petName: 'Athena', ownerId: '14', ownerName: 'William Brown', type: 'Vaccination', status: 'scheduled', notes: 'Breeding female vaccination' },
  { id: '24', date: '2026-01-13', time: '11:00', petId: '24', petName: 'Apollo', ownerId: '14', ownerName: 'William Brown', type: 'Check-up', status: 'scheduled', notes: 'Young dog development check' },
  { id: '25', date: '2026-01-13', time: '14:30', petId: '25', petName: 'Cleo', ownerId: '14', ownerName: 'William Brown', type: 'Check-up', status: 'scheduled', notes: 'Sphynx skin care exam' },
  { id: '26', date: '2026-01-13', time: '16:00', petId: '26', petName: 'Biscuit', ownerId: '15', ownerName: 'Camila Herrera', type: 'Vaccination', status: 'scheduled', notes: 'Puppy vaccination series' },
  { id: '27', date: '2026-01-14', time: '10:30', petId: '27', petName: 'Tucker', ownerId: '16', ownerName: 'Alexander Davis', type: 'Check-up', status: 'scheduled', notes: 'Active dog wellness exam' },
  { id: '28', date: '2026-01-15', time: '09:00', petId: '28', petName: 'Maple', ownerId: '16', ownerName: 'Alexander Davis', type: 'Check-up', status: 'scheduled', notes: 'Senior cat check-up' },
  { id: '29', date: '2026-01-15', time: '14:00', petId: '29', petName: 'Rosie', ownerId: '17', ownerName: 'Valentina Ruiz', type: 'Check-up', status: 'scheduled', notes: 'Heart condition monitoring' },
  { id: '30', date: '2026-01-16', time: '10:30', petId: '30', petName: 'Scout', ownerId: '18', ownerName: 'Christopher Taylor', type: 'Vaccination', status: 'scheduled', notes: 'Puppy series in progress' },
  { id: '31', date: '2026-01-16', time: '15:00', petId: '31', petName: 'Willow', ownerId: '18', ownerName: 'Christopher Taylor', type: 'Grooming', status: 'scheduled', notes: 'Long-haired kitten first groom' },
  { id: '32', date: '2026-01-17', time: '09:30', petId: '1', petName: 'Luna', ownerId: '1', ownerName: 'María García', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination due' },
  { id: '33', date: '2026-01-17', time: '14:00', petId: '2', petName: 'Max', ownerId: '1', ownerName: 'María García', type: 'Check-up', status: 'scheduled', notes: 'Senior cat wellness' },
  { id: '34', date: '2026-01-20', time: '10:30', petId: '3', petName: 'Buddy', ownerId: '2', ownerName: 'John Smith', type: 'Check-up', status: 'scheduled', notes: 'Post-vaccination check' },
  { id: '35', date: '2026-01-20', time: '15:00', petId: '4', petName: 'Whiskers', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Vaccination', status: 'scheduled', notes: 'Annual feline vaccination' },
  { id: '36', date: '2026-01-21', time: '09:00', petId: '5', petName: 'Rocky', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Check-up', status: 'scheduled', notes: 'Post-surgery follow-up' },
  { id: '37', date: '2026-01-21', time: '11:00', petId: '6', petName: 'Mittens', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Vaccination', status: 'scheduled', notes: 'One year booster' },
  { id: '38', date: '2026-01-21', time: '14:30', petId: '7', petName: 'Coco', ownerId: '4', ownerName: 'Carlos Mendez', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness exam' },
  { id: '39', date: '2026-01-22', time: '10:30', petId: '8', petName: 'Oliver', ownerId: '5', ownerName: 'Sarah Johnson', type: 'Check-up', status: 'scheduled', notes: 'Weight management follow-up' },
  { id: '40', date: '2026-01-23', time: '09:00', petId: '9', petName: 'Bella', ownerId: '5', ownerName: 'Sarah Johnson', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination' },
  { id: '41', date: '2026-01-23', time: '14:00', petId: '10', petName: 'Simba', ownerId: '6', ownerName: 'Roberto Fernández', type: 'Check-up', status: 'scheduled', notes: 'Post-vaccination check' },
  { id: '42', date: '2026-01-24', time: '10:30', petId: '11', petName: 'Daisy', ownerId: '7', ownerName: 'Emily Watson', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },
  { id: '43', date: '2026-01-24', time: '15:00', petId: '12', petName: 'Thor', ownerId: '8', ownerName: 'Miguel Torres', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness exam' },
  { id: '44', date: '2026-01-27', time: '09:00', petId: '13', petName: 'Nala', ownerId: '8', ownerName: 'Miguel Torres', type: 'Grooming', status: 'scheduled', notes: 'Full grooming service' },
  { id: '45', date: '2026-01-27', time: '11:00', petId: '14', petName: 'Ginger', ownerId: '9', ownerName: 'Jennifer Lee', type: 'Check-up', status: 'scheduled', notes: 'Arthritis medication review' },
  { id: '46', date: '2026-01-27', time: '14:30', petId: '15', petName: 'Duke', ownerId: '10', ownerName: 'David Kim', type: 'Check-up', status: 'scheduled', notes: 'Giant breed wellness' },
  { id: '47', date: '2026-01-28', time: '09:30', petId: '16', petName: 'Princess', ownerId: '10', ownerName: 'David Kim', type: 'Vaccination', status: 'scheduled', notes: 'Annual feline vaccination' },
  { id: '48', date: '2026-01-28', time: '14:00', petId: '17', petName: 'Shadow', ownerId: '10', ownerName: 'David Kim', type: 'Check-up', status: 'scheduled', notes: 'Shy cat wellness exam' },
  { id: '49', date: '2026-01-29', time: '10:30', petId: '18', petName: 'Mochi', ownerId: '11', ownerName: 'Sofia Reyes', type: 'Check-up', status: 'scheduled', notes: 'Puppy development check' },
  { id: '50', date: '2026-01-29', time: '15:00', petId: '19', petName: 'Charlie', ownerId: '12', ownerName: 'James Wilson', type: 'Check-up', status: 'scheduled', notes: 'Ear infection monitoring' },
  { id: '51', date: '2026-01-30', time: '09:00', petId: '20', petName: 'Pepper', ownerId: '12', ownerName: 'James Wilson', type: 'Check-up', status: 'scheduled', notes: 'Annual feline wellness' },
  { id: '52', date: '2026-01-30', time: '14:00', petId: '21', petName: 'Lola', ownerId: '13', ownerName: 'Isabella Martinez', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination' },
  { id: '53', date: '2026-01-31', time: '10:30', petId: '22', petName: 'Zeus', ownerId: '14', ownerName: 'William Brown', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },

  // February 2026 Appointments (reduced, with variance - 1-3 per day, Mondays not blank)
  { id: '74', date: '2026-02-03', time: '10:00', petId: '1', petName: 'Luna', ownerId: '1', ownerName: 'María García', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness exam' },
  { id: '75', date: '2026-02-03', time: '14:30', petId: '22', petName: 'Zeus', ownerId: '14', ownerName: 'William Brown', type: 'Check-up', status: 'scheduled', notes: 'Show dog annual exam' },
  { id: '76', date: '2026-02-04', time: '09:30', petId: '23', petName: 'Athena', ownerId: '14', ownerName: 'William Brown', type: 'Grooming', status: 'scheduled', notes: 'Breeding show grooming' },
  { id: '77', date: '2026-02-05', time: '14:00', petId: '24', petName: 'Apollo', ownerId: '14', ownerName: 'William Brown', type: 'Check-up', status: 'scheduled', notes: 'Young dog development' },
  { id: '78', date: '2026-02-07', time: '10:30', petId: '2', petName: 'Max', ownerId: '1', ownerName: 'María García', type: 'Vaccination', status: 'scheduled', notes: 'Senior cat vaccination' },
  { id: '79', date: '2026-02-10', time: '09:00', petId: '3', petName: 'Buddy', ownerId: '2', ownerName: 'John Smith', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },
  { id: '80', date: '2026-02-10', time: '14:00', petId: '4', petName: 'Whiskers', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Check-up', status: 'scheduled', notes: 'Annual feline wellness' },
  { id: '81', date: '2026-02-11', time: '10:30', petId: '5', petName: 'Rocky', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Check-up', status: 'scheduled', notes: 'Post-dental cleaning check' },
  { id: '82', date: '2026-02-12', time: '09:00', petId: '6', petName: 'Mittens', ownerId: '3', ownerName: 'Ana Rodríguez', type: 'Check-up', status: 'scheduled', notes: 'Young adult wellness' },
  { id: '83', date: '2026-02-12', time: '14:30', petId: '7', petName: 'Coco', ownerId: '4', ownerName: 'Carlos Mendez', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination' },
  { id: '84', date: '2026-02-13', time: '10:30', petId: '8', petName: 'Oliver', ownerId: '5', ownerName: 'Sarah Johnson', type: 'Check-up', status: 'scheduled', notes: 'Weight management progress' },
  { id: '85', date: '2026-02-14', time: '09:00', petId: '9', petName: 'Bella', ownerId: '5', ownerName: 'Sarah Johnson', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness' },
  { id: '86', date: '2026-02-14', time: '14:00', petId: '10', petName: 'Simba', ownerId: '6', ownerName: 'Roberto Fernández', type: 'Vaccination', status: 'scheduled', notes: 'One year booster' },
  { id: '87', date: '2026-02-17', time: '10:30', petId: '11', petName: 'Daisy', ownerId: '7', ownerName: 'Emily Watson', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },
  { id: '88', date: '2026-02-18', time: '09:00', petId: '12', petName: 'Thor', ownerId: '8', ownerName: 'Miguel Torres', type: 'Grooming', status: 'scheduled', notes: 'Full service grooming' },
  { id: '89', date: '2026-02-18', time: '14:30', petId: '13', petName: 'Nala', ownerId: '8', ownerName: 'Miguel Torres', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness' },
  { id: '90', date: '2026-02-19', time: '10:30', petId: '14', petName: 'Ginger', ownerId: '9', ownerName: 'Jennifer Lee', type: 'Check-up', status: 'scheduled', notes: 'Senior arthritis monitoring' },
  { id: '91', date: '2026-02-20', time: '09:00', petId: '15', petName: 'Duke', ownerId: '10', ownerName: 'David Kim', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination' },
  { id: '92', date: '2026-02-20', time: '14:00', petId: '16', petName: 'Princess', ownerId: '10', ownerName: 'David Kim', type: 'Check-up', status: 'scheduled', notes: 'Annual feline wellness' },
  { id: '93', date: '2026-02-21', time: '10:30', petId: '17', petName: 'Shadow', ownerId: '10', ownerName: 'David Kim', type: 'Vaccination', status: 'scheduled', notes: 'Annual vaccination' },
  { id: '94', date: '2026-02-24', time: '09:00', petId: '18', petName: 'Mochi', ownerId: '11', ownerName: 'Sofia Reyes', type: 'Check-up', status: 'scheduled', notes: 'Young dog wellness' },
  { id: '95', date: '2026-02-24', time: '14:30', petId: '19', petName: 'Charlie', ownerId: '12', ownerName: 'James Wilson', type: 'Vaccination', status: 'scheduled', notes: 'Annual booster' },
  { id: '96', date: '2026-02-25', time: '10:30', petId: '20', petName: 'Pepper', ownerId: '12', ownerName: 'James Wilson', type: 'Check-up', status: 'scheduled', notes: 'Annual wellness' },
  { id: '97', date: '2026-02-26', time: '09:00', petId: '21', petName: 'Lola', ownerId: '13', ownerName: 'Isabella Martinez', type: 'Check-up', status: 'scheduled', notes: 'Behavioral progress check' },
  { id: '98', date: '2026-02-26', time: '14:00', petId: '25', petName: 'Cleo', ownerId: '14', ownerName: 'William Brown', type: 'Vaccination', status: 'scheduled', notes: 'Annual feline vaccination' },
  { id: '99', date: '2026-02-27', time: '10:30', petId: '26', petName: 'Biscuit', ownerId: '15', ownerName: 'Camila Herrera', type: 'Vaccination', status: 'scheduled', notes: 'Puppy vaccination completion' },
  { id: '100', date: '2026-02-28', time: '09:00', petId: '27', petName: 'Tucker', ownerId: '16', ownerName: 'Alexander Davis', type: 'Check-up', status: 'scheduled', notes: 'Active dog wellness' },
];
